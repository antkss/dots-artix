...
class Logger(logging.getLoggerClass()):
    ...
    def __init__(self, logger_name=None, formatter_arg=None):
        """
        ...
        """
        if formatter_arg is None:
            formatter_arg = self.log_format
        formatter = logging.Formatter(fmt=formatter_arg["fmt"])
